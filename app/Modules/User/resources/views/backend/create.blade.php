...
<div class="card">
    <div class="card-header">
        <span class="card-title "><i class="fa fa-user mr-2"></i> Create User</span>
    </div>
    <!-- /.card-header -->
    {!! Form::open(['route'=>array('users.store'), 'method'=>'POST','enctype'=>'multipart/form-data','id'=>'dataForm']) !!}
    <div class="card-body">
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::text('email','',['class'=>$errors->has('email')?'form-control is-invalid':'form-control','placeholder'=>'Email']) !!}
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('role','Role : ') !!}
                    {!! Form::select('roles[]',$roles,'[]',['class'=>$errors->has('role')?'form-control is-invalid':'form-control','placeholder'=>'Select:']) !!}
            </div>
        </div>
        <div class="row">  
            <div class="col-md-3">
    ...
    <div class="card-footer">
        <a href="{{ route('users.index') }}" class="btn btn-dark"><i class="fa fa-backward mr-1"></i>
            Back</a>
        <button type="submit" class="btn float-right btn-success"><i class="fa-solid fa-square-plus mr-1"></i> Add </button>
    </div>
    {!! Form::close() !!}
</div>
</div>
