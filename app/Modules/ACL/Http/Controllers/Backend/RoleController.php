...
class RoleController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function index(RoleDataTable $dataTable, Role $roles)
    {
       return $dataTable->render("ACL::roles.index",compact('roles'));
    }
    ...
    public function show($id)
    {
        ...
        return view('ACL::roles.show',compact('role','rolePermissions'));
    }
